...
class TestAndroidAgentComponents(unittest.TestCase):
    ...
    def test_ui_parser_xml(self):
        ...
        <hierarchy rotation="0">
            <node index="0" text="Settings" resource-id="com.android.settings:id/title" class="android.widget.TextView" package="com.android.settings" content-desc="" clickable="true" enabled="true" focused="false" bounds="[50,100][400,200]" />
            <node index="1" text="Network" resource-id="com.android.settings:id/summary" class="android.widget.TextView" package="com.android.settings" content-desc="Network settings" clickable="true" enabled="true" focused="false" bounds="[50,220][400,320]" />
        </hierarchy>"""
