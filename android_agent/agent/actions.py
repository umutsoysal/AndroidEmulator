...
class AgentAction(BaseModel):
    ...
    element_id: Optional[int] = Field(
        default=None,
        description="Numeric element ID from UI tree to interact with."
    )
    ...
    text: Optional[str] = Field(
        default=None,
        description="Text string to type for TYPE_TEXT action."
    )
    ...
    package_name: Optional[str] = Field(
        default=None,
        description="Package name to launch for LAUNCH_APP."
    )
    ...
    result_message: Optional[str] = Field(
        default=None,
        description="Final result message when action_type is FINISH."
    )
